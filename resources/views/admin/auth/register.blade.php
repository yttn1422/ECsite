<x-guest-layout>
    <form method="POST" action="{{ route('admin.register') }}">
        ...
        <!-- Admin Code -->
        <div class="mt-4">
            <x-input-label for="admin_code" :value="__('出品者コード')" />
            <x-text-input id="admin_code" class="block mt-1 w-full" type="password" name="admin_code" required autocomplete="off" />
